...
final class FakeUser implements UserObjectInterface
{
    ...
    public function verifyPassword(string $password): bool { return false; }
    public function createToken(): string { return ''; }
    public function isTokenValid(string $token): bool { return false; }
    public function resetPassword(): bool { return false; }
    public function hasRole(int $role): bool { return $this->role === $role; }

    public function validate(): bool { return true; }
    public function errorMessage(): string { return ''; }
    public function create(): self { return $this; }
    public function read(int $id): ?self { return $this; }
...
it('defaults to read-only when role is missing', function () {
    $user = new class implements UserObjectInterface {
        public function getProperty(string $name, mixed $default = null): mixed { return $default; }
        public function setProperty(string $name, mixed $value): void {}
        public function setPassword(string $value) {}
        public function getPassword(): ?string { return null; }
        public function verifyPassword(string $password): bool { return false; }
        ...
        public function isTokenValid(string $token): bool { return false; }
        public function resetPassword(): bool { return false; }
        public function hasRole(int $role): bool { return false; }
        public function validate(): bool { return true; }
        public function errorMessage(): string { return ''; }
        public function create(): self { return $this; }
        public function read(int $id): ?self { return $this; }
