                    ...
                    <tbody>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            if (empty($edit) || $row["mov_id"] != $edit) {
                                $category_filter = stripos($filter_string, "filter_entry_type=") == false ? "$filter_string&filter_entry_type={$row['tipo_mov']}" : preg_replace("/filter_entry_type=(\w)/", $row['tipo_mov'], $filter_string);
                                $account_filter = stripos($filter_string, "filter_conta_id=") == false ? "$filter_string&filter_conta_id={$row['conta_id']}" : preg_replace("/filter_conta_id=(\w)/", "filter_conta_id=" . $row['conta_id'], $filter_string);
                        ?>
