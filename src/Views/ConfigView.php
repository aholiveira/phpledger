                ...
                <main>
                    <div class="main config" id="main">
                        <?php if ($hasPermission): ?>
                            <form method="post">
                                <?= CSRF::inputField() ?>
                                <p><label for="title"><?= $this->app->l10n()->l("application_name") ?></label><input id="title" name="title" value="<?= $t ?>"></p>
                                <p><label for="smtp_host"><?= $this->app->l10n()->l("smtp_host") ?></label><input id="smtp_host" name="smtp_host" value="<?= $smtp_host ?>"></p>
                                <p><label for="smtp_port"><?= $this->app->l10n()->l("smtp_port") ?></label><input id="smtp_port" name="smtp_port" type="number" min="1" max="65535" value="<?= $smtp_port ?>" required></p>
                                <p><label for="smtp_from"><?= $this->app->l10n()->l("from") ?></label><input id="smtp_from" name="smtp_from" value="<?= $smtp_from ?>"></p>
                                <p><label for="id"><?= $this->app->l10n()->l("url") ?></label><input id="url" name="url" value="<?= $url ?>"></p>
                                <p><label for="storage_type"><?= $this->app->l10n()->l("storage_type") ?></label>
