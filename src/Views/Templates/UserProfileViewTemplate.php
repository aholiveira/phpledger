                ...
                <main>
                    <div class="main config single_item" id="main">
                        <form method="POST">
                            ...
                            <p><label for="username"><?= $label['username'] ?></label><input type="text" id="username" name="username" value="<?= $this->htmlSafe($text['username']) ?>" readonly></p>
                            <p><label for="firstName"><?= $label['first_name'] ?></label><input type="text" id="firstName" name="firstname" value="<?= $this->htmlSafe($text['firstName']) ?>"></p>
                            <p><label for="lastName"><?= $label['last_name'] ?></label><input type="text" id="lastName" name="lastname" value="<?= $this->htmlSafe($text['lastName']) ?>"></p>
                            <p><label for="fullName"><?= $label['display_name'] ?></label><input type="text" id="fullName" name="fullName" value="<?= $this->htmlSafe($text['fullName']) ?>"></p>
                            <p><label for="email"><?= $label['email'] ?></label><input type="text" id="email" name="email" value="<?= $this->htmlSafe($text['email']) ?>"></p>
